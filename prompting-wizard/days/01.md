...
Nouns compound with counts and formats, but those are later levers. Today, just name the thing — and the top rung adds economy: no words spent on the artifact beyond what pins it down.
...
> Help me with a findings list for {{TASK}}.

The verb did not move. The noun did the work: "a findings list" is a thing that either exists at the end or does not, while count, format, and quality stay open for later lessons.
